...
class User < ApplicationRecord
  ...
  has_many(:accepted_sent_follow_requests, -> {where status:"accepted"}, class_name:"follow_request", foreign_key:"sender_id", primary_key:"id")
  ...
  has_many(:accepted_received_follow_requests, ->{where status:"accepted"}, class_name:"follow_id", foreign_key:"recipient_id", primary_key:"id")
